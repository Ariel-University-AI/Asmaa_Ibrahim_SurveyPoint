...
שים לב לסוג הקואורדינטות:
- תיק ישן (לפני 1994): רשת ישראל הישנה — Y ו-X בטווח 0-300,000
- תיק חדש (אחרי 1994): ITM — Y בטווח 100,000-900,000, X בטווח 0-300,000
- חישובים מקומיים: קואורדינטות קטנות יחסית (עשרות עד אלפים)

חפש בכל סוג טבלה: חשוב מצולע, חשוב קואורדינטות, חשוב שטחים.
העתק ערכים בדיוק כמו שכתוב — אל תשנה ואל תמציא.
אל תכלול ערכי סיכום (2A=, A=, סך הכל).

החזר JSON בלבד: [{"name":"שם_נקודה","Y":0.0,"X":0.0}, ...]
אין קואורדינטות בדף — החזר: []"""
