...
כללי שמות נקודה:
- שמות תקינים: מספרים בלבד (1, 15, 4318), מספר+אות (15A, 3B, 1240G)
- אל תכלול: טקסט עברי, סימנים כמו & ( ) = *, או שם ארוך מ-6 תווים

סוגי קואורדינטות:
- תיק ישן (מקומי): Y ו-X בטווח 100-5000 — אם ערך > 5000 ולא ITM, בדוק שגיאת קריאה
- תיק חדש (ITM): Y בטווח 100,000-900,000, X בטווח 0-300,000
- אל תכלול ערכי סיכום (2A=, A=, שורות סך הכל)

חפש בכל סוג טבלה: חשוב מצולע, חשוב קואורדינטות, חשוב שטחים.
העתק ערכים בדיוק. אל תמציא נקודות שאינן בדף.
